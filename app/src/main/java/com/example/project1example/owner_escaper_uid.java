...
public class owner_escaper_uid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_owner_escaper_uid);
    ...
    private void Writetv(String response) {
        try {
            ...
            if (obj.optString("status").equalsIgnoreCase("true")){
                ...
                progress_layout.setVisibility(View.GONE);
                error_layout.setVisibility(View.VISIBLE);
                Toast.makeText(owner_escaper_uid.this, obj.optString("message") + "", Toast.LENGTH_SHORT).show();
            } else {
                progress_layout.setVisibility(View.GONE);
                error_layout.setVisibility(View.VISIBLE);
                Toast.makeText(owner_escaper_uid.this, "Error in server", Toast.LENGTH_SHORT).show();
            }
